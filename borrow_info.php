	...
	<body>
		...
		<div class="container" style="margin-top: 10px;">
			...
			<div class="row">
				<div class="col-sm-3">
					<div class="panel panel-default">
						...
						<div class="panel-body">
							<img class="el-userhead" src="static/images/head_icon.jpg" id="userIcon">
							<p class="text-center">
							...
							<div>
								...
								<label class="label label-success"> <span class="glyphicon glyphicon-user"></span> </label>
				...
				<div class="col-sm-6">
					<h3 class="text-info" style="margin-top: 0px;"> zs借款 <small><label class="label label-primary">信</label></small></h3>
					<div>
						<table width="100%" height="250px">
							<tbody>
								<tr>
									<td class="muted" width="80px">借款金额</td>
									<td class="text-info" style="padding-left: 10px;"> 2,000.00 </td>
								</tr>
								<tr>
									<td class="muted ">年化利率</td>
									<td class="text-info" style="padding-left: 10px;"> 10.00% </td>
								</tr>
								<tr>
									<td class="muted ">借款期限</td>
									<td class="text-info" style="padding-left: 10px;"> 3月 </td>
								</tr>
								<tr>
									<td class="muted">投标奖励</td>
									<td class="text-info" style="padding-left: 10px;"> 0.00 </td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td class="text-info" style="padding-left: 10px;"> 20.00 </td>
								</tr>

								<tr>
									<td class="muted">剩余时间</td>
									<td class="text-info" style="padding-left: 10px;">
										<div id="retroclockbox"></div></td>
								</tr>
							</tbody>
						</table>
					</div>
				...
				<div class="col-sm-3">
					<table style="height:110px;width:230px;">
						<tbody>
							<tr>
								<td class="muted">投标总数</td><td class="text-info" style="padding-left: 10px;"> 2 </td>
							</tr>
							<tr>
								<td class="muted">还需金额</td><td class="text-info" style="padding-left: 10px;"> 0.00元 </td>
							</tr>
							<tr>
					...
					<table>
						<tbody>
							<tr>
								...
								<td width="20%" style="padding-left: 10px;" class="text-info"> 2015-03-30 </td>
								<td class="muted text-right">借款额度</td>
								<td width="20%" style="padding-left: 10px;" class="text-info"> 2000 </td>
								<td class="muted text-right">性别</td>
								<td width="20%" style="padding-left: 10px;" class="text-info"> 男 </td>
								<td class="muted text-right">年龄</td>
								<td width="20%" style="padding-left: 10px;" class="text-info"> 25 </td>
							</tr>
							<tr>
								<td class="muted text-right">文化程度</td>
								<td width="20%" style="padding-left: 10px;" class="text-info"> 硕士研究生 </td>
								<td class="muted text-right">每月收入</td>
								<td width="20%" style="padding-left: 10px;" class="text-info"> 3000-4999 </td>
							</tr>
						</tbody>
					</table>
				</div>
					...
					<table>
						<tbody>
							<tr>
								...
								<td width="10%" style="padding-left: 10px;" class="text-info"> 优 </td>
								<td class="muted text-right">信贷知识掌握情况</td>
								<td width="10%" style="padding-left: 10px;" class="text-info"> 优 </td>
								<td class="muted text-right">借款感言</td>
								<td width="50%" style="padding-left: 10px;" class="text-info"> 给我2000度过难关 </td>
							</tr>
							<tr>
			...
			<div class="panel panel-default">
				...
				<div class="panel-body" id="matMsg">
